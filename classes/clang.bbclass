...
BASE_DEFAULT_DEPS_append_class-nativesdk_toolchain-clang_runtime-llvm = " clang-native nativesdk-libcxx nativesdk-compiler-rt"

# do_populate_sysroot needs STRIP
POPULATESYSROOTDEPS_toolchain-clang_class-target = "${MLPREFIX}clang-cross-${TARGET_ARCH}:do_populate_sysroot"
